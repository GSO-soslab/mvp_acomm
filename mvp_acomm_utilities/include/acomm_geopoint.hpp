...
#include "mvp_acomm_interfaces/msg/evologics_usbl_data.hpp"
...
private:
    ...
    void f_usbl_callback(const mvp_acomm_interfaces::msg::EvologicsUsblData::SharedPtr msg);

    //  //subscriber
    rclcpp::Subscription<geographic_msgs::msg::GeoPoseStamped>::SharedPtr m_ref_geopose_sub;
    rclcpp::Subscription<mvp_acomm_interfaces::msg::EvologicsUsblData>::SharedPtr evologics_usbl_sub;
